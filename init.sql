...
('064', '파인만의 여섯가지 물리 이야기', '리처드 필립 파인만', 12000, 'science', '', '/images/book64.jpg', '/images/64-1.jpg'),
...
('082', '이게 되네? 챗GPT 미친 활용법 71제', '오힘찬', 24000, 'computer_it', '아직도 ‘챗GPT로 어떤 것까지 할 수 있을까? 유료 구독을 할 가치가 있을까?’ 고민하는가? 챗GPT를 단순히 신기한 AI가 아닌 실생활에 ‘진짜’ 활용하고 싶은가? 이 책으로 그 답을 얻어보자. 누구보다 더 효과적으로 더 적극적으로 챗GPT를 활용하는 방법을 알려주는 이 책이 인공지능 시대에 일잘러, 작가, 영상 편집자, 현인으로서 살아갈 여러분의 마법의 지팡이가 되어줄 것이다.', '/images/book82.jpg', '/images/book82-1.jpg'),
...
('085', 'Do it! 점프 투 파이썬', '박응용', 22000, 'computer_it', '프로그래밍 분야 8년 연속 베스트셀러!『Do it! 점프 투 파이썬』 전면 개정 2판 출시!중고등학생도, 비전공자도, 직장인도 프로그래밍에 눈뜨게 만든 바로 그 책이 전면 개정 2판으로 새롭게 태어났다! 챗GPT를 시작으로 펼쳐진 생성 AI 시대에 맞춰 설명과 예제를 다듬고, 최신 경향과 심화 내용을 보충했다. 또한 이번 개정 2판도 50만 코딩 유튜버인 조코딩과 협업을 통해 유튜브 동영상을 제공해 파이썬을 더 쉽게 공부할 수 있다.', '/images/book85.jpg', '/images/book85-1.jpg'),
