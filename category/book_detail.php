            ...
            <form class="gd_rvCmtWrite" method="post" action="../review.php" enctype="multipart/form-data">
                ...
                <div class="row_rating">
                    <span id="cmt_rating" class="rvCmt_rating">
                        ...
                        <span class="starGrp">
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                <a href="javascript:void(0)" onclick="SetRatingStar(<?= $i ?>);"><em class="bgGD rating" id="rating_<?= $i ?>">★</em></a>
                            <?php endfor; ?>
                        </span>
                    </span>
                </div>
                <div class="row_txtArea improved-review-form">
                    <textarea id="comment" name="content" placeholder="리뷰를 작성해주세요" maxlength="500" oninput="document.getElementById('ipt_msg_txtLen').querySelector('strong').innerText = this.value.length;"></textarea>
                    ...
                    <div class="review-item">
                        <div class="review-content-wrapper">
                            ...
                            <div class="review-info">
                                ...
                                <span class="review-date"><?= htmlspecialchars(date('Y-m-d', strtotime($review['created_at']))) ?></span>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        window.SetRatingStar = function(score) {
