...
// 사용자 정보 가져오기
$user_sql = "SELECT name, email, point FROM users WHERE id = $user_id";
        ...
        <div class="mypage-content">
            <aside class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><button onclick="showTab('point')">포인트 관리</button></li>
                    ...
                    <?php foreach ($orders as $order_id => $order): ?>
                        <div class="order-item">
                            ...
                            <div class="order-actions" style="text-align:right; margin-top:10px;">
                                <a href="order_detail.php?order_id=<?= $order['order_id'] ?>">상세보기</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
